...
const TOPIC_EMOJIS: { keywords: string[]; emoji: string }[] = [
  ...
  { keywords: ["veranstaltung", "festival", "konzert", "feier", "stadtfest", "volksfest", "weinfest"], emoji: "🎉" },
  { keywords: ["wahl", "abstimmung", "landtag", "bundestag"], emoji: "🗳️" },
  { keywords: ["wetter", "sturm", "regen", "schnee", "unwetter"], emoji: "🌦️" },
  { keywords: ["fußball", "1. fc", "bundesliga", "dfb", "kicken", "fußballspiel", "halbzeit", "abpfiff"], emoji: "⚽" },
